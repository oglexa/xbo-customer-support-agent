# 🌙 Night Agent — Morning Report

**Generated:** 2026-05-28 17:06:50  
**Total runtime:** 316.1s  

## Summary

| Suite | Status | Pass Rate | Passed | Failed | Time |
|-------|--------|-----------|--------|--------|------|
| Part 2A — Functional Tests | ⚠️ Completed | 18.2% | 2 | 9 | 76.1s |
| Part 2B — RAG Retrieval Tests | ⚠️ Completed | 0.0% | 0 | 11 | 65.5s |
| Part 2C — Security / Injection Tests | ⚠️ Completed | 84.6% | 11 | 2 | 119.8s |
| Part 2D — Hallucination Tests | ⚠️ Completed | 0.0% | 0 | 10 | 54.6s |

## Part 2A — Functional Tests

**Status:** ⚠️ 9/11 FAILED  

- ❌ What is the withdrawal fee for BTC? (similarity: 0.5588)
- ❌ What are the KYC withdrawal limits? (similarity: 0.3208)
- ❌ What happens if I forget to include the Destination Tag when depositing Ripple (XRP)? (similarity: 0.6560)
- ❌ Can I complete my Tier 2 identity verification by uploading a photo of my student ID or a corporate ... (similarity: 0.4432)
- ✅ What is the effective Maker fee for a VIP 2 tier user who has enabled the 'Pay Fees with APX' toggle... (similarity: 0.8155)
- ❌ I updated my 2FA settings and now my account is locked with error code SEC-LOCK-48. What should I do... (similarity: 0.6174)
- ❌ What happens to my active spot and futures trading orders if my account gets flagged for a complianc... (similarity: 0.4692)
- ❌ If I am a Tier 2 user and withdraw $30,000 USD worth of crypto at 14:00 UTC, when can I withdraw ano... (similarity: 0.7658)
- ✅ Can I claim staking rewards for the period during which my account was placed under an interim lockd... (similarity: 0.9052)
- ❌ Why did I receive $30 less than expected on my international SWIFT fiat withdrawal when the exchange... (similarity: 0.7539)
- ❌ What is the REST API rate limit for private trading endpoints, and what happens if my bot triggers a... (similarity: 0.7315)
...
- ❌ How does an account freeze due to suspicious activity affect my running trading orders and my monthl... (P@k: 0.67, R@k: 1.00)
...
- ❌ How long will my funds be locked out if I reset my password, and what error code will I see on the s... (P@k: 0.67, R@k: 1.00)
...
- ❌ Does an interim security lockdown pause my daily staking interest accumulation, and can I recover th... (P@k: 0.33, R@k: 0.50)
...
---
*Report generated automatically by Night Agent at 2026-05-28 17:06:50*