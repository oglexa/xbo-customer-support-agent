# XBO Help Center: Fiat Currency Deposits & Withdrawals

To bridge the gap between traditional banking and digital assets, XBO supports a variety of fiat currency payment rails. All fiat operations are subject to regional banking laws, processing schedules, and explicit security parameters.

### Permitted Fiat Gateways and Processing Windows

XBO currently supports United States Dollars (USD) and Euros (EUR). The operational processing windows align directly with the guidelines referenced in our *Asset Withdrawal Fees Schedule*:
...
3. **Domestic & International Wires:**
   * **Deposits:** Free on XBO's end, though intermediary banks may apply wire fees. Settles within 24 hours if received before 13:00 EST.
   * **Withdrawals:** $25 flat fee for domestic; up to $250 for international SWIFT wires.

### Critical Compliance Rules for Fiat Transfers

* **Third-Party Payment Ban:** The legal name on the originating or destination bank account **must exactly match** the verified legal name on the XBO account (see *Account Verification Policy*). Third-party transfers—including deposits from friends, corporate accounts (for individual profiles), or unregistered entities—will be automatically rejected. Rejected transfers are returned to the source bank minus a 5% administrative handling fee.
