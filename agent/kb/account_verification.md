...
1. **Tier 1 (Basic Verification):**
   * **Requirements:** Full legal name, date of birth, country of residence, and verified mobile phone number.
   * **Processing Time:** Instant (automated checks).
   * **Capabilities:** Enables cryptocurrency deposits and limited internal trading. Fiat operations and external withdrawals are restricted.

2. **Tier 2 (Advanced Verification):**
   * **Requirements:** All Tier 1 data plus a high-resolution scan of a government-issued photo ID (passport, national ID card, or driver's license) and a real-time biometric selfie verification.
   * **Processing Time:** 1 to 24 hours.
   * **Capabilities:** Unlocks standard withdrawal capabilities, fiat currency deposits/withdrawals, and access to API key generation.

3. **Tier 3 (Pro Verification):**
   * **Requirements:** All Tier 2 data plus a valid proof of address (utility bill, bank statement, or government correspondence issued within the last 90 days) showing the user's full name and residential address.
   * **Processing Time:** 24 to 48 hours (manual compliance review).
   * **Capabilities:** Unlocks maximum institutional limits, OTC trading desk access, and priority customer support.
